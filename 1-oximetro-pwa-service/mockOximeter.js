 ...
 *
 * Este módulo representa o "hardware": no mundo real, a PWA leria isso
 * diretamente do dispositivo via Web Bluetooth API. Aqui, quem expõe
 * essas leituras é o oximetro-service, e quem consome é a PWA
 * (patient-simulator.html), exatamente como aconteceria com o BLE real.
 *
 * Campos:
...
module.exports = { generateReading, setScenario, getScenario };
